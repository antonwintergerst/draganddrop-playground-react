...
// base component
// this component should render a dog meme card for use in a horizontal list
class DogMemeCard extends Component {
  static propTypes = {
...
let DragSourceCard = DragSource(ItemTypes.DOG, {
  beginDrag(props) {
    return {
      id: props.id,
      index: props.index,
...
let DropTargetCard = DropTarget(ItemTypes.DOG, {
